...
def test_release_wheel_has_one_resource_owner_and_complete_metadata() -> None:
    with ZipFile(_release_wheel()) as archive:
        ...
        assert {
            ...
            "evolve/runtime/policy.py",
            "evolve/frozen/public_artifacts.py",
            "evolve/containers/runtime-versions.env",
            ...
            "evolve/recipes/hyperagents_codex_tbench_full/evolve.yaml",
            "evolve/recipes/hyperagents_dsh/evolve.yaml",
            "evolve/recipes/hyperagents_tbench_full/evolve.yaml",
            ...
            "evolve/agent_driver.py",
            "evolve/candidate/package.py",
            "evolve/integrations/harbor/isolated_candidate.py",
            "evolve/runtime/model_broker.py",
            "evolve/containers/candidate-worker/Dockerfile",
